...
export function HackathonStats({ delay = 0 }: { delay?: number }) {
  return (
    <GridWrapper>
        ...
        {stats.map((stat, index) => (
          ...
          >
            <div className="relative flex items-center justify-center min-h-[120px] md:min-h-[140px] w-full">
              ...
              <div
                className="relative text-2xl md:text-3xl font-bold leading-none text-blue-600 z-10"
                style={{
                  fontFamily: "var(--font-geist-sans), system-ui, sans-serif",
                  letterSpacing: "-0.02em"
                }}
            ...
            <div className="text-base -mt-[50px] md:-mt-[52px] md:text-lg font-medium text-blue-600">
              {stat.label}
            </div>
          </motion.div>
        ))}
